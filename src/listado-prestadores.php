				...
				<div class="row">
					...
					<section class="col-xs-12 col-sm-9  listado-publicaciones">
						...
						<div style="border-top:1px solid #e6e6e6">
							...
							<div class="col-xs-12 publicacion">
								<a href="perfil.php">
								<div class="col-xs-5 div_img_listado">
								...
								<div class="col-xs-7 cuerpo_listado_prestadores">
									<h2>Juan Ignacio Costela</h2>
										...
										<i class="fa fa-star" aria-hidden="true"></i>
										<i class="fa fa-star" aria-hidden="true"></i>
										<p class="resumen_perfil">
											Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur<br/> 
											exmauris, tempor vitae rutrum non, tempor vitae nunc.
										</p>
								</div>
									
									<div class="col-xs-7 footer_listado_publicacion">
										<i class="fa fa-map-marker" aria-hidden="true"></i>
										<span>Berazategui</span>
										
										<a href="" class="btn  showMoreButton">Ver Perfil</a>
										</div>
